...
namespace PLCCommunication_v2.Panasonic.Controls
{
    public class ResultData : INotifyPropertyChanged
    {
        ...
        {
            get => this.m_ReceiveData != null ? this.m_ReceiveData.DeviceCode : EPLCDeviceCode.D;
        }

        public int DeviceNumber => this.m_ReceiveData != null ? this.m_ReceiveData.Address : 0;

        public string DeviceHexNumber
        {
            get => this.m_ReceiveData != null ? this.m_ReceiveData.ContactAddress : "0000";
        }
        ...
        private void ChangeResultText()
        {
            ...
            switch (this.m_DataType)
            {
                ...
                case EParseDataType.String:
                    this.ResultText = this.m_ReceiveData.GetASCIIString();
                    break;
                default:
